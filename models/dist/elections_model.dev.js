...
var e_dbConfig = require("../config/elections");

var Sequelize = require('sequelize');

var e_sequelize = new Sequelize(e_dbConfig.DATABASE, e_dbConfig.USER, e_dbConfig.PASSWORD, {
  host: e_dbConfig.HOST,
  dialect: e_dbConfig.DIALECT
});
var e_db = {};
e_db.sequelize = e_sequelize;
e_db.models = {}; // e_db.models.User = require('./user')(sequelize, Sequelize.DataTypes);
