...
var t_dbConfig = require("../config/tourism");

var Sequelize = require('sequelize');

var t_sequelize = new Sequelize(t_dbConfig.DATABASE, t_dbConfig.USER, t_dbConfig.PASSWORD, {
  host: t_dbConfig.HOST,
  dialect: t_dbConfig.DIALECT
});
var t_db = {};
t_db.sequelize = t_sequelize;
t_db.models = {}; // e_db.models.User = require('./user')(sequelize, Sequelize.DataTypes);
