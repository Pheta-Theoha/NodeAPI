...
var h_dbConfig = require("../config/hospitality");

var Sequelize = require('sequelize');

var h_sequelize = new Sequelize(h_dbConfig.DATABASE, h_dbConfig.USER, h_dbConfig.PASSWORD, {
  host: h_dbConfig.HOST,
  dialect: h_dbConfig.DIALECT
});
var h_db = {};
h_db.sequelize = h_sequelize;
h_db.models = {}; // e_db.models.User = require('./user')(sequelize, Sequelize.DataTypes);
