...
var s_dbConfig = require("../config/studentReg");

var Sequelize = require('sequelize');

var s_sequelize = new Sequelize(s_dbConfig.DATABASE, s_dbConfig.USER, s_dbConfig.PASSWORD, {
  host: s_dbConfig.HOST,
  dialect: s_dbConfig.DIALECT
});
var s_db = {};
s_db.sequelize = s_sequelize;
s_db.models = {}; // e_db.models.User = require('./user')(sequelize, Sequelize.DataTypes);
